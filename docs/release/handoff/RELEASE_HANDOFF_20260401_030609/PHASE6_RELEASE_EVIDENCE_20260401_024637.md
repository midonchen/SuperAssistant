...
- Generated at (UTC): `2026-04-01T02:46:37Z`
...
- Started (UTC): `2026-04-01T02:46:37Z`
- Ended (UTC): `2026-04-01T02:46:49Z`
- Status: `PASS`
...
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
5 passed, 10 deselected, 1 warning in 0.34s
[phase5] acceptance passed.
[phase6-ready] 4/4 phase6 perf smoke...
[phase6-perf] voice parse p95: 2.44 ms (target <= 1200 ms)
[phase6-perf] ocr parse p95: 2.72 ms (target <= 2800 ms)
[phase6-perf] offline replay 100 jobs: 125.20 ms (target <= 30000 ms)
[phase6-perf] PASS
[phase6-ready] PASS
[phase6-pack] 3/3 execute external-load gate...
[phase6-load] home_inventory_list: total=400, errors=0, p95=87.27ms, avg=28.44ms, max=168.77ms, throughput=601.73rps, target_p95<=1500ms
[phase6-load] voice_parse: total=120, errors=0, p95=18.41ms, avg=13.37ms, max=22.04ms, throughput=662.95rps, target_p95<=1200ms
[phase6-load] ocr_parse: total=120, errors=0, p95=16.61ms, avg=12.20ms, max=17.53ms, throughput=689.98rps, target_p95<=2800ms
[phase6-load] offline_enqueue_100: 3.32ms (target <= 30000ms)
[phase6-load] PASS
[phase6-pack] PASS
