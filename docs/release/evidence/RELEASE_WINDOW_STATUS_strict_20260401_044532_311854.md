...
- Generated at (UTC): `2026-04-01T04:45:32Z`
- Strict mode: `True`
...
- Signoff draft file: `RELEASE_SIGNOFF_DRAFT_20260401_044532.md`

## Wave Readiness

- Wave 10%: file=`GRAY_WAVE_10_20260401_044529.md`, mode=`live`, snapshot=`OK`, base_url=`http://127.0.0.1:18080/api/v1`, non_local=`False`, ready=`True`
- Wave 50%: file=`GRAY_WAVE_50_20260401_044531.md`, mode=`live`, snapshot=`OK`, base_url=`http://127.0.0.1:18080/api/v1`, non_local=`False`, ready=`True`
- Wave 100%: file=`GRAY_WAVE_100_20260401_044532.md`, mode=`live`, snapshot=`OK`, base_url=`http://127.0.0.1:18080/api/v1`, non_local=`False`, ready=`True`
